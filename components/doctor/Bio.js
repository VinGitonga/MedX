        ...
        <Card>
            ...
            <Box mt={2}>
                <SimpleGrid columns={{ base: 4, md: 2, lg: 2 }} spacing={'20px'}>
                    ...
                    <Box mx={2}>
                        <Text color={'gray.400'} fontWeight={600} fontSize='sm' textTransform={'uppercase'}>Gender</Text>
                        <Text color={'gray.900'} fontSize={'md'}>{user.gender}</Text>
                    </Box>
                    <Box mx={2}>
                        <Text color={'gray.400'} fontWeight={600} fontSize='sm' textTransform={'uppercase'}>Date of Birth</Text>
